package com.hdl.dancer.booking.presentation.helper

import android.net.Uri
import androidx.navigation.NavHostController
import com.hdl.dancer.booking.data.extension.toJson
import com.hdl.dancer.booking.data.model.response.BookingDTO
...
import com.hdl.dancer.booking.presentation.model.support.Updatable
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.BOOKING_DATE
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.BOOKING_DTO
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.BOOKING_ID
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.BOOKING_TIME
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.CLOSE_TIME
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.CLUB_ID
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.CLUB_IMAGE
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.CLUB_NAME
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.DANCER_AVATARS
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.DANCER_IDS
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.DANCER_NAMES
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.EMAIL
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.EXCLUDE_DANCER_IDS
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.GUESTS
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.HAS_NOW
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.HAS_SHOW_BUTTONS
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.HOME_TAB
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.ID
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.IS_IN_APP
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.LAWYER_ID
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.NAME
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.OPEN_TIME
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.PHOTOS_URL
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.PHOTO_URL
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.PICKED_DANCER_ID
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.PICK_FOR_BOOKING
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.REVIEW_TOTAL
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.ROOM_ID
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.ROOM_NAME
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.SONGS
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.TOTAL_AMOUNT
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.TABLE_NUMBER
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.CUSTOMER_NAME
import com.hdl.dancer.booking.presentation.helper.AppNavigator.Companion.ArgKey.CUSTOMER_PHONE
