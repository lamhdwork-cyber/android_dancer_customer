...
object AppConfig {
    ...
    object Booking {
        /** API / DTO string values for [com.hdl.dancer.booking.data.model.response.BookingDTO.status]. */
        object Status {
    ...
    /**
     * Values from [com.hdl.dancer.booking.data.model.response.UserDTO.role] after login.
     */
    object UserRole {
        const val USER = "user"
